...
<script>
import SidebarMenuByRole from "./SidebarMenuByRole.vue";
...
export default {
  ...
  created() {
    if (this.$store.state.userdata != null) {
      switch (this.$store.state.userdata.intRoleID) {
        case 1:
          this.menus = SidebarMenuByRole.superadmin;
          break;
        case 2:
          this.menus = SidebarMenuByRole.admin;
          break;
        case 3:
          this.menus = SidebarMenuByRole.supervisor;
          break;
        case 4:
          this.menus = SidebarMenuByRole.inspector;
          break;
        case 5:
          this.menus = SidebarMenuByRole.inspector;
          break;
        default:
          this.menus = SidebarMenuByRole.guest;
      }
    } else {
      this.menus = SidebarMenuByRole.guest;
    }
