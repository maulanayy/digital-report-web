...
const routes = [
  ...
  { path: "/seeting/ewon/add", component: EwonAdd },
  { path: "/seeting/ewon/edit/:id", component: EwonAdd },
  { path: "/setting/oracle", component: SettingOracle },
  { path: "/seeting/oracle/add", component: OracleAdd },
  { path: "/seeting/oracle/edit/:id", component: OracleAdd },
  { path: "/setting/role", component: SettingRole },
  { path: "/seeting/role/add", component: RoleAdd },
  { path: "/seeting/role/edit/:id", component: RoleAdd },
