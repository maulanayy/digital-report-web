...
const routes = [
  ...
  { path: "/area/edit/:id", component: AreaAdd },
  { path: "/control_point/", component: CPData },
  { path: "/control_point/add/", component: CPAdd },
  { path: "/control_point/edit/:id", component: CPAdd },
  { path: "/form/", component: FormData },
  { path: "/form/add/", component: FormAdd },
  { path: "/setting/ewon", component: SettingEwon },
  { path: "/setting/ewon/add", component: EwonAdd },
  { path: "/setting/ewon/edit/:id", component: EwonAdd },
  { path: "/setting/oracle", component: SettingOracle },
  { path: "/setting/oracle/add", component: OracleAdd },
  { path: "/setting/oracle/edit/:id", component: OracleAdd },
  { path: "/setting/role", component: SettingRole },
  { path: "/setting/role/add", component: RoleAdd },
  { path: "/setting/role/edit/:id", component: RoleAdd },
  { path: "/setting/permission", component: SettingPermission },
  { path: "/setting/permission/add", component: SettingPermissionAdd },
  { path: "/setting/permission/edit/:id", component: SettingPermissionAdd },
